 ...
 * @LastEditTime: 2021-12-29 17:27:04
 * @LastEditors: zlc
 * @Description: 
 * @FilePath: \git项目\project-template\uni_template\pages\form\collapse\indexVerson\index1.vue
-->
<template>
  <view class="collapse">
    <view class="collapse-text">基础用法</view>
    <Card>
